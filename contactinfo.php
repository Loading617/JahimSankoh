...
<html lang="en">
<head>
<title>Jahim Sankoh | Contact Info</title>
<meta charset="UTF-8">
...
<div class="wrapper">
    ...
    <div class="text-box">
    <?php echo "Email Me:" ; ?>
    <?php echo "<a href="mailto:jahimsankoh319@gmail.com" target="_blank">jahimsankoh319@gmail.com</a>" ; ?>
    <?php echo "Phone:" ; ?>
    <?php echo "<a href="tel:803-846-0324" target="_blank">Call Me for Questions, Contributing to any of my Projects on GitHub, You can Reach Me Here: (803) 846-0324</a>" ; ?>
    <h4>Socials:</h4>
    <ul>
      ...
      <li><a href="https://www.instagram.com/jusbeing.jahim/" target="_blank"><img src="instagram.png" alt="Instagram" width="32" height="32"></a></li>
      <li><a href="https://www.twitter.com/jahim4x" target="_blank"><img src="x.png" alt="X formely Twitter" width="32" height="32"></a></li>
